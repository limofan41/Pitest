...
public enum CRCRMutator4 implements MethodMutatorFactory {
  ...
  private final class CRCRVisitor4 extends MethodVisitor {
    ...
    CRCRVisitor4(final MutationContext context,
    ...
    private <T extends Number> boolean shouldMutate(final T constant,
      ...
      final MutationIdentifier mutationId = this.context.registerMutation(
          CRCRMutator4.this, "Substituted " + constant + " with "
              + replacement);
  ...
  public MethodVisitor create(final MutationContext context,
    ...
    return new CRCRVisitor4(context, methodVisitor);
  }
